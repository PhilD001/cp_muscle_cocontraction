...
%
% RETURNS
%  cc (co-contraction indices)          ...   n x 1  vector of co-contraction indices incase of Rudolph and Falconer
% (or)
%  cc (common area curve) and cc_value           ...   (1) n x 1  vector of minima form two curves used to estimate co-contraction incase
