function bmech_emgprocess_test(fld,ch,varargin)
...
if nargin ==3
    lp_cut = varargin{1};    % assigns input low-pass fillter cutoff
elseif nargin ==2
...
for i = 1:length(fl)    
    ...
    data = zload(fl{i});
    data = emgprocess_data(data,ch,lp_cut);
    zsave(fl{i},data);
end


function data = emgprocess_data(data,emg_ch,lp_cut)
