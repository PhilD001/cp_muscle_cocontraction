...
%  subplot(s1);plot(data.LVM_normalized .line); title('LVM');hold on;
...
%  subplot(s6);plot(data.RVM_normalized .line);title('RVM');hold on;  
 subplot(s7);plot(data.RTibAnt_filthigh_filtlow.line); title('RTibAnt');hold on; 
 subplot(s8);plot(data.RGM_filthigh_filtlow.line);title('RGM');hold on;  
 subplot(s9);plot(data.RHam_filthigh_filtlow.line);title('RHam');hold on;  
 subplot(s10);plot(data.RRF_filthigh_filtlow.line);title('RRF');hold on; 
 end