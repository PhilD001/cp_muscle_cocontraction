function r = extractevents_3(fld,cons,subjects,ch,evt)
...
% updated to convert MCo to a correct format for omni_ttest
    ...
    for j = 1:length(file)
        ...
        if ~isempty(file)
            ...
            if isempty(evtval)                                  % searches for global event
                ...
                evtval(2) = data.(ch).event(evtval(1));          % found
            end
